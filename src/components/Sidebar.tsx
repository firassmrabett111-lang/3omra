...
import { Network, Binary, Code2, FileCode, Settings, BarChart3, GitCompare, Workflow, Cpu, BookOpen } from "lucide-react";
import { sectionList, type SectionId } from "@/data/modbusData";

const iconMap: Record<string, React.ComponentType<{ className?: string }>> = {
  Network, Binary, Code2, FileCode, Settings, BarChart3, GitCompare, Workflow, Cpu, BookOpen
};
